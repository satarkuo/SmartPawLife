...
const ProductCard = ({product}) => {
    ...
    return (<Link to={`/productList/${product.id}`} 
        ...
        <div className="productCard">
            ...
            <span className={`material-icons favoriteBtn ${favoriteList[product.id] && 'active'}`}
                onClick={(e) => toggleFavorite(e, product.id)}></span>
