            ...
            <tbody>
              {cartList.carts?.length >= 1 ? (
                ...
                <tr className="mb-0 nodata">
                  <td colSpan="7" className="text-center text-body-tertiary">
                    購物車沒有商品
                  </td>
                </tr>
              )}
            ...
            <div className="col-12 col-lg-8" style={{ paddingRight: !isMobile && '120px' }}>
              <div className="d-flex align-items-center justify-content-between justify-content-lg-end pb-2">
                ...
                <div className="text-end border-0" style={{ width: '130px' }}>
                  ...
                  >
                    $ {cartList.carts?.length >= 1 ? cartList.total.toLocaleString() : 0}
                  </b>
                </div>
              </div>
              {cartList.total > cartList.final_total && (
                <div>
                  ...
                  <div className="d-flex align-items-center justify-content-between justify-content-lg-end py-2">
                    總金額
                    <div className="text-end border-0" style={{ width: '130px' }}>
                      <b className="text-primary h4">$ {cartList.final_total.toLocaleString()}</b>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="my-5 row justify-content-center">
            <form className="col-md-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-3">
                ...
                />
                {errors.tel && <p className="textBody3 text-primary my-2">{errors.tel.message}</p>}
              </div>
              <div className="mb-3">
